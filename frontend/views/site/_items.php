...
<div class="card" style="width: 18rem;" >
    <a href="<?= URL::toRoute(['site/detalhes', 'id' => $model->idProduto ?? $model->produtos]) ?>" ><img class="card-img-top" src="<?= Yii::getAlias('@web') ?>/../../common/Images/<?= $model->imagem ?? $model->produtos->imagem ?>" alt="Card image cap"></a>
    <div class="card-body">
        <a href="<?= URL::toRoute(['site/detalhes', 'id' => $model->idProduto ?? $model->produtos]) ?>" ><h5 class="card-title"><?= $model->nome ?? $model->produtos->nome ?></h5></a>
