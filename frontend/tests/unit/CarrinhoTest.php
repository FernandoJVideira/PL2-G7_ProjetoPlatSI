...
class CarrinhoTest extends \Codeception\Test\Unit
{
    ...
    public function testValidations()
    {
        ...
        $morada = $this->tester->grabRecord('common\models\Morada', ['rua' => 'Ruas']);
        ...
        $carrinho->setAttribute('id_morada', 2); //Morada com id 2 não existe na base de dados
        ...
        $carrinho->setAttribute('id_user', 5); //Utilizador com id 5 não existe na base de dados
        ...
        $carrinho->setAttribute('id_promocao', 10); //Promoção com id 5 não existe na base de dados
    ...
    public function testSaveUpdateDelete()
    {
        ...
        $this->tester->seeRecord('common\models\Carrinho', ['idCarrinho' => 1]);

        //Test Update
        $carrinho = $this->tester->grabRecord('common\models\Carrinho', ['idCarrinho' => 1]);
        $carrinho->estado = 'emProcessamento';
        $carrinho->save();

        $this->tester->seeRecord('common\models\Carrinho', ['idCarrinho' => 1, 'estado' => 'emProcessamento']);
        $this->tester->dontSeeRecord('common\models\Carrinho', ['idCarrinho' => 1, 'estado' => 'aberto']);

        //Test Delete
        $carrinho->delete();
        $this->tester->dontSeeRecord('common\models\Carrinho', ['idCarrinho' => 1]);
